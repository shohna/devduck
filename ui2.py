...
class VoiceChatApp(ctk.CTk):
    def __init__(self):
        ...
        self.text_input_frame.grid(row=2, column=0, padx=(20, 20), pady=(0, 10), sticky="ew")
        self.text_input_frame.grid_columnconfigure(0, weight=1)

        # Text entry widget
        self.text_entry = ctk.CTkEntry(self.text_input_frame, placeholder_text="Type your message here...")
        self.text_entry.grid(row=0, column=0, padx=(0, 10), pady=10, sticky="ew")

        # Send button
        self.send_button = ctk.CTkButton(self.text_input_frame, text="Send", command=self.send_text)
        self.send_button.grid(row=0, column=1, padx=(0, 10), pady=10)

        # Buttons frame
        self.button_frame = ctk.CTkFrame(self.main_frame)
        self.button_frame.grid(row=3, column=0, padx=(20, 20), pady=(0, 20), sticky="ew")
